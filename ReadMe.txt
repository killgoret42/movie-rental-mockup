This is a project that I adapted from a college project so that I could show off my coding skills. Orginally the project used an
SQLServer database, but I adapted it so it could use an Access database on my home machine.
...
If you want to go straight to the exe, go to: MovieRentalMockupProject\obj\Debug\MeramecNetFlixProject.exe

If you want to test out the admin features, you can use the following login information:
Username: admin
Password: password

NOTE: you will need AccessDatabaseEngine installed for the program to function properly. You can install it using the .exe near this
file.